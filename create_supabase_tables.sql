-- 🌾 Création des tables pour AgroConnect sur Supabase
...
BEGIN
    ...
    AND table_name IN (
        'users_user', 'products_product', 'products_order', 
        'products_cart', 'products_message', 
        'products_agriculturaladvice', 'products_culture'
    );
    
    IF table_count = 7 THEN
        RAISE NOTICE '✅ Toutes les tables AgroConnect créées avec succès!';
    ELSE
