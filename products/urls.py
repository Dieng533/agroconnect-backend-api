...
urlpatterns = [
    ...
    path('api/cart/', views.CartListView.as_view(), name='cart-list'),
    path('api/cart/<int:pk>/', views.CartDetailView.as_view(), name='cart-detail'),
    path('api/cart/clear/', views.CartClearView.as_view(), name='cart-clear'),
    
    path('api/farmers/', views.FarmerListView.as_view(), name='farmer-list'),
    
    path('api/messages/', views.MessageListView.as_view(), name='message-list-create'),
    path('api/messages/<int:pk>/', views.MessageDetailView.as_view(), name='message-detail'),
    path('api/messages/conversation/<int:user_id>/', views.ConversationView.as_view(), name='conversation'),
    
    path('api/cultures/', views.CultureListCreateView.as_view(), name='culture-list-create'),
    path('api/cultures/<int:pk>/', views.CultureDetailView.as_view(), name='culture-detail'),
    
    path('api/advice/', views.AgriculturalAdviceListView.as_view(), name='advice-list'),
    path('api/advice/<int:pk>/', views.AgriculturalAdviceDetailView.as_view(), name='advice-detail'),
    path('api/advice/create/', views.AgriculturalAdviceCreateView.as_view(), name='advice-create'),
